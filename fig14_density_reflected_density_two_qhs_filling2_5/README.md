# Fig. 14 -- density_reflected_density_two_qhs_filling2_5.pdf

Two quasiholes at nu = 2/5 (N = 80, omega = 15.0 lB, k1 = 0, k2 in
...
- Source script:
  ...
  (the `let` block producing `density_reflected_density_two_qhs_filling2_5.pdf`,
  `N=80, omega=15.0`).
- Source data:
  `authors-code/CompositeFermionsDisk/post_processed_data/density_N80_nu2_5_omega15.0_k1_0_k2_{0,1,2}_conventional.jld2`
